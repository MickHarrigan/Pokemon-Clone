...
const int FORFEIT = 3; // number defined for the user to forfeit the game
const int SWAP = 2; // when the user wants to swap the Pokemon
const int ATTACK = 1; // when the user wants to attack the enemy
const int USER_WIN = 1; // when the user has won the game
const int ENEMY_WIN = 2; // when the enemy has won the game
const int BATTLE_BROKE = 0; // if there is an error within the battle

class Game {
public:
  // Name: Game Constructor
  // Desc - Creates a new game and sets m_filename based on string passed
  // Additionally, makes m_list and userPokemon = new PokemonLists
