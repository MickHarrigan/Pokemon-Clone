...
const int YOUR_DEATH = 1; // user's pokemon has passed
const int ENEMY_DEATH = 2; // enemy's pokemon has passed
const int DASH_LENGTH = 80; // used to separate important outputs
